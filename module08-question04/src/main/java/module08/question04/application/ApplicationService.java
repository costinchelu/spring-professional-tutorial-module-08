package module08.question04.application;

import module08.question04.ds.Guest;
import module08.question04.ds.Room;
import module08.question04.service.GuestRegistrationService;
import module08.question04.service.HotelManagementService;
...
public class ApplicationService {
    ...
    public void registerGuests(Guest... guests) {
        List.of(guests).forEach(guestRegistrationService::registerGuest);
    }
